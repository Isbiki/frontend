    ...
    row: {
      ...
      <div className="flex-grow-1">
        <h5 className="mt-0 mb-1">
          <Link to={`/posts/${id}`} className="text-reset">
            {name}
          </Link>
        </h5>
...
const PostsListTable = ({
  ...
  return <ReactTable columns={columns} data={posts} rowsPerPageList={pageSizeList} pageSize={10} tableClass="text-nowrap mb-0" theadClass="bg-light bg-opacity-50" showPagination />;
};
