...
const AddMain = ({ tableRefresh, isUpdate, updateClicked, selectedItem }) => {
            ...
            <form className="authentication-form" onSubmit={handleSubmit(onSubmit)}>
                <ModalBody>
                    ...
                    <Row>
                        ...
                        <Col lg={6}>
                            <TextFormInput control={control} name="sort_order" label="Sort Order" placeholder="Sort Order" containerClassName="mb-3" id="sort-order" />
                        </Col>
                    </Row>
                    <Row>
                        <Col lg={12}>
                            <TextFormInput control={control} name="data_query" label="Data Query" placeholder="Data Query" containerClassName="mb-3" id="data-query" />
                        </Col>
                    </Row>
